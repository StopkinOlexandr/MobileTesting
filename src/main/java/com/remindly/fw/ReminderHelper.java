...
public class ReminderHelper extends BaseHelper{
  ...
  public void addReminderInterval(String s) {
    tap(By.id("RepeatNo"));
    pause(1000);
    type(By.className("android.widget.EditText"),s);
    pause(1000);
    tap(By.id("button1"));
  }

  public void getTypeOfRepetition(String s) {
    tap(By.id("repeat_type_text"));
    pause(1000);
    if (s.equals("Minute")) {
      tapWithCoordinates(450, 700);
      pause(1000);
    } else if (s.equals("Hour")) {
      tapWithCoordinates(450, 820);
      pause(1000);
    } else if (s.equals("Day")) {
      tapWithCoordinates(450, 970);
      pause(1000);
    } else if (s.equals("Week")) {
      tapWithCoordinates(450, 1120);
      pause(1000);
    } else if (s.equals("Month")) {
      tapWithCoordinates(450, 1275);
      pause(1000);
    }
  }

  public void switchRepeatOn() {
